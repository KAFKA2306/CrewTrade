...
from ai_trading_crew.use_cases.data_clients.pricing import get_price_series
...
class Index7PortfolioDataPipeline:
    ...
    def _combine_close(self, frames: Dict[str, pd.DataFrame], as_of: pd.Timestamp | None = None) -> pd.DataFrame:
