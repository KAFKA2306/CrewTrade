...
from ai_trading_crew.use_cases.index_7_portfolio.reporting import Index7PortfolioReporter
...
class Index7PortfolioUseCase(BaseUseCase):
    ...
    def fetch_data(self) -> Dict[str, Any]:
        ...
        print(f"  ✓ Date range: {data_payload['prices'].index.min()} to {data_payload['prices'].index.max()}")
        return data_payload
    ...
    def execute(self, config_path: Path | None = None) -> dict:
        ...
        print(f"\n{'='*60}")
        print(f"Index 7-Portfolio Use Case")
        print(f"{'='*60}\n")
