...
class SemiconductorsAnalyzer:
    ...
    def _calculate_metrics(
        ...
        try:
            ...
            return_3m = self._calculate_period_return(prices, 63)
            return_6m = self._calculate_period_return(prices, 126)
            return_12m = self._calculate_period_return(prices, 252)
