...
from crew.crew import StockComponentsSummarizeCrew
from crew.market_overview_agents import MarketOverviewAnalyst
...
def train():
    ...
    inputs = {
        ...
        "current_time_est": datetime.datetime.now(pytz.timezone("US/Eastern")).strftime(
            "%Y-%m-%d %H:%M:%S"
        ),
    }
