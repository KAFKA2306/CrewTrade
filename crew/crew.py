...
class BaseCrewClass:
    ...
    def __init__(
        self,
        symbol,
        stocktwit_llm=DEFAULT_STOCKTWITS_LLM,
    ...
    def relevant_news_filter_task(self) -> Task:
        ...
        return Task(
            ...
            output_file=os.path.join(
                AGENT_INPUTS_FOLDER,
                today_str_no_min,
                f"{self.symbol}_{RELEVANT_ARTICLES_FILE}",
            ),
            verbose=True,
        )
    @crew
    ...
    def technical_indicator_summarization_task(self) -> Task:
        ...
        return Task(
            ...
            output_file=os.path.join(
                ...
                today_str_no_min,
                self.symbol,
                "technical_indicator_summary_report.md",
            ),
            llm=self.technical_ind_llm,
            verbose=True,
        )
    ...
    def fundamental_analysis_task(self) -> Task:
        ...
        return Task(
            ...
            output_file=os.path.join(
                ...
                today_str_no_min,
                self.symbol,
                "fundamental_analysis_summary_report.md",
            ),
            llm=PROJECT_LLM,
            verbose=True,
        )
    ...
    def timegpt_forecast_task(self) -> Task:
        ...
        return Task(
            ...
            output_file=os.path.join(
                ...
                today_str_no_min,
                self.symbol,
                "timegpt_forecast_summary_report.md",
            ),
            verbose=True,
        )
    @crew
    ...
    def crew(self) -> Crew:
        ...
        return Crew(
            ...
            output_log_file=os.path.join(
                LOG_FOLDER,
                today_str_no_min,
                f"day_trader_advisor_{self.symbol}_{today_str_no_min}.log",
            ),
        )
